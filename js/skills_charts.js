...
var data_right = [87.5, 75, 75, 62.5, 62.5, 50],
	data_right_name = ['','','','','','HTML & CSS','PHP','JavaScript','Python','MySQL','ASP.NET'],
	data_right_colors = ['f9d595','91e0f2','f9d595','91e0f2','91e0f2','91e0f2'],
	data_skill_names = ["","Acemi","Bilgili","Erişkin","Uzman"],
...
var data_left = [87.5, 87.5, 75, 62.5, 50, 50],
	data_left_name = ['','','','','','C#','Kotlin','VB.NET','Java','Swift','Scala'],
	data_left_colors = ['f9b495','b1f2e3','f9b495','b1f2e3','b1f2e3','b1f2e3'],
	data_skill_names1 = ["Uzman","Erişkin","Bilgili","Acemi",""],
	data_legend1 = ['','','','','','','','','','','','Masaüstü','Mobil'],
